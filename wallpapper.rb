...
class Wallpapper < Formula
  homepage 'https://github.com/zhimingsui/wallpapper'
  url 'https://github.com/zhimingsui/wallpapper/archive/1.7.2.tar.gz'
  sha256 '9f8dc5059256731903daa66e510332b6b4a5e3f217ba658c208acbc3d5d97dd6'

  head 'https://github.com/zhimingsui/wallpapper.git'
